...
- (id)init
{
    ...
    if (self) {
        ...
        _label.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:18.0f];
        ...
        _itemCompleteLayer.backgroundColor = [[[UIColor alloc] initWithRed:0.0 green:0.6 blue:0.0 alpha:0.3] CGColor];
...
{
    if ([self.delegate cellShoudBeginEditing:self] == YES) {
